...
const getOrThrow = (app: App, name: string): string => {
...
const stackDescription = (moduleName: string, includeGuidanceCode: boolean) => `Infrastructure for ${moduleName} module${includeGuidanceCode ? ' -- Guidance for Sustainability Optimization Scenarios Evaluator (SXXX).' : '.'}`;
